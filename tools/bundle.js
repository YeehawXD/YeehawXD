 ...
 * bundling is just inlining css/style.css and the js modules into index.html in
 ...
 *
 * Also exported as build() so tools/app.js can produce the same file for the
 * Xcode and Electron shells without shelling out.
 */
'use strict';
const fs = require('fs');
